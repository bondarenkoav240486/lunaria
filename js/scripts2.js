...
function addInfoPortfolioAndContactsToHeaderTop() {
    ...
    )
    {
        ...
        // stand_with_Ukraine.style.marginRight = '15%';
        // stand_with_Ukraine.style.marginLeft = '5%';
    } else {
        infoPortfolioAndContacts.remove();
...
//     div.innerHTML = '.AAAAAAAAAA';
//     div.style.cssText = 'position: absolute; z-index: 10000; color: green; cursor: default';
//     document.body.appendChild(div);
//     div.style.left = e.clientX + 1
//      + 'px';
//     div.style.top = e.clientY + 1 + 'px';
//     setTimeout(function () {document.body.removeChild(div)}, 200);
